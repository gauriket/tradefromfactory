  ...
  return (
    <>
        ...
        <div className="hidden 800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between ">
          ...
          <div className="w-[50%] relative">
            <input
              ...
              className="h-[40px] w-full px-2 border-[#FCB901] border-[2px] rounded-md"
            />
            <AiOutlineSearch
              size={30}
          ...
          <div className={`${styles.button}`}>
            <Link to={`${isSeller ? "/dashboard" : "/seller-info"}`}>
      ...
      <div
        ...
        } transition hidden 800px:flex items-center justify-between w-full bg-[#FCB901] h-[70px]`}
      >
        <div
      ...
      >
        <div className="w-full flex items-center justify-between">
          ...
          <div className="bg-[#FCB901] rounded-lg px-1 py-1">
            <Link to="/">
              <img
                src="https://tradefromfactory.com/wp-content/uploads/2023/08/Trade-From-Factory-Logo.png"
                alt=""
